...
<div class="flex flex-row mb-16">
    <div class="text-left flex-1 px-14 font-khand text-xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
    ...
    <div>
        <img src="{{ asset('images/aboutUs.jpg') }}" alt="About" class="w-fit h-96 flex-1 px-4">
    </div>
</div>
